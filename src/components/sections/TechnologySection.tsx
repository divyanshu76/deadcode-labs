...
export function TechnologySection() {
  return (
    <section id="foundation" className="py-16 md:py-24 bg-background border-t border-border overflow-hidden">
      <Container>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 md:gap-6 pt-8 border-t border-border/70">
          {techCategories.map((group, index) => (
            <motion.div
              ...
              className="space-y-3"
            >
              <h3 className="font-mono text-xs font-semibold tracking-wider uppercase text-foreground border-b border-border/50 pb-2">
                {group.category}
              </h3>
